...
class LatestProductPricesScreen extends StatelessWidget {
  final List<Product>? products;
  
  const LatestProductPricesScreen({ Key? key, this.products }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: SearchAppBar(
        ...
        label: AppLocalizations.of(context)!.latestProductPrices,
