      ...
      children: [
        ...
        Align(
          ...
          child: widget.product.discountedPrice != null 
            ...
            : Text(
              AppLocalizations.of(context)!.price + PriceBuilder.build(price: widget.product.price, currency: widget.product.currency),
              style: Theme.of(context).textTheme.headline2!.copyWith(fontSize: 22, fontWeight: FontWeight.w700) ,
            ), 
        ),
        WidgetMethods.verticalSpace(10),
        Align(
          ...
          child: Column(
            ...
            children: [
              Text(
                "${AppLocalizations.of(context)!.store}: \"${widget.product.storeName}\"",
                style: Theme.of(context).textTheme.headline2!.copyWith(fontStyle: FontStyle.italic),
              ),
              WidgetMethods.verticalSpace(10),
              Text(
                "${AppLocalizations.of(context)!.location}: \"${widget.product.storeLocation}\"",
                style: Theme.of(context).textTheme.headline2!.copyWith(fontStyle: FontStyle.italic),
              ),
            ] 
          ),
